...
const SubButton = styled.button`
  ...
  background-color: ${(props) =>
    props.active ? ColorCode.SelectBlue : ColorCode.UnSelectBlue};
  color: white;
  border: none;
  border-radius: 17px;
  cursor: pointer;
...
const Subject = () => {
  ...
  return (
    <SubjectContainer>
      <Title>
        <p style={{ color: "ColorCode.SelectBlue" }}>토킹</p>메이트 시작하기
      </Title>
      <Documentcontainer>
